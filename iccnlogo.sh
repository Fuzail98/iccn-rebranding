...
if [ "$out2" == '"ICCN"' ] and 
then
        echo "Changes in the core file have been made!!! Please refresh and/or clear cache on your browser to see the changes."
else
        echo "No changes in the core file have taken place. Please try again!"
fi
